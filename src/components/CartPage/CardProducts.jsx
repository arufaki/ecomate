            ...
            <div className="p-3 min-[1200px]:p-6 min-[1024px]:px-6 flex flex-row items-center justify-between min-[1024px]:justify-normal">
                <div className="flex flex-row items-center gap-2 min-[1024px]:flex-[1_36%] min-[1200px]:flex-[1_38%]">
                    ...
                    <div className="w-[54px] h-[54px] sm:w-[110px] sm:h-[110px]">
                        <img src="/assets/webp/spoon-dummy.webp" className="object-cover object-center w-full h-full rounded-md" alt="product-image" />
                    </div>
                    <div className="pl-1 md:pl-[40px]">
                        <h1 className="text-xs font-semibold text-[#262626] sm:text-base min-[1200px]:text-[24px] pb-2 sm:pb-3">{product.name}</h1>
                ...
                <h1 className="text-[9px] text-[#262626] sm:text-base min-[1024px]:flex-[1_6%] xl:text-lg">{formatToIDR(product.price)}</h1>
                <Trash2 color="#A51D1D" width={16} className="sm:w-5 min-[1024px]:w-6 cursor-pointer" onClick={() => handleDeleteProduct(product.id)} />
            </div>
        </div>
    ));
};
