    ...
    <div className="max-w-screen-xl mx-auto px-[25px]">
      <div className="py-[40px]">
        <p className="text-[36px] font-bold text-xl sm:text-4xl mb-[13px]">
          Tantangan saya ({myChallenges.length})
        </p>
                ...
                <div>
                  <div className="w-full h-[251px] bg-lightgray bg-cover bg-center overflow-hidden rounded-lg">
                    <img
                      ...
                      src={challenge.challengeImg || "/placeholder.png"}
                      alt={challenge.title || "Challenge Image"}
                    />
                  </div>

                  <div>
                    <h3 className="text-neutral-800 text-xl font-bold tracking-tight pt-[16px]">
                      {challenge.title || "Tantangan Tanpa Judul"}
                    </h3>
                    <p className="text-justify text-neutral-800 text-base font-normal leading-normal tracking-tight">
                      {challenge.description || "Deskripsi belum tersedia."}
                    </p>
                  </div>
                </div>
