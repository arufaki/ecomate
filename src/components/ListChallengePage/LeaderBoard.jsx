                ...
                <div className="flex justify-center items-center mt-10 space-x-2 md:space-x-10">
                    ...
                    <div className="flex flex-col items-center transform scale-90">
                        ...
                        <div className="flex flex-col justify-center text-center items-center mb-4">
                                ...
                                <img src={User} className="w-[70px] h-[70px] md:w-[150px] md:h-[150px] object-cover object-top rounded-full"/>
                            </div>
                            <h2 className="text-white text-base md:text-4xl font-bold">{sortedLeaderboard[1].exp} EXP</h2>
                            <p className="text-white/80 text-sm md:text-2xl">{sortedLeaderboard[1].name}</p>
                        </div>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="bg-[#F4F4D7] rounded-[16px] md:rounded-[48px] p-3 md:p-8 w-[114px] h-fit md:w-[300px] md:h-[538px] text-center">
                            <div className="flex flex-col justify-center text-center items-center mb-4">
                                ...
                                <img src={User} className="w-[70px] h-[70px] md:w-[200px] md:h-[200px] object-cover object-top rounded-full"/>
                            </div>
                            <h2 className="text-primary text-base md:text-5xl font-bold my-2 md:my-5">{sortedLeaderboard[0].exp} EXP</h2>
                            <p className="text-primary text-sm md:text-3xl">{sortedLeaderboard[0].name}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center transform scale-90">
                        ...
                        <div className="flex flex-col justify-center text-center items-center mb-4">
                            ...
                            <h2 className="text-white text-base md:text-4xl font-bold">{sortedLeaderboard[2].exp} EXP</h2>
                            <p className="text-white/80 text-sm md:text-2xl"> {sortedLeaderboard[2].name}</p>
                        </div>
                        ...
                        {sortedLeaderboard.slice(3).map((leader, index) => (
                            <div key={index} className="flex flex-row justify-between items-center p-5 w-[323px] md:w-[1088px] h-[80px] md:h-[136px] bg-secondary rounded-[24px] my-5">
                                <div className="flex flex-row items-center text-primary text-base md:text-3xl font-bold">
                                    ...
                                    <img src={User} className="md:w-[88px] md:h-[88px] w-[66px] h-[66px] object-cover object-top rounded-full mx-2 md:mx-10"/>
