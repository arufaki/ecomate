...
// const ModalEditChallenges = ({ selectedChallenge }) => {
...
//         category_impact: categoryImpact1 || "",
//         coin: selectedChallenge?.coin || "",
//         description: selectedChallenge?.description || "",
//         difficulty: selectedChallenge?.difficulty || "",
//         duration_days: selectedChallenge?.duration_days || "",
//         exp: selectedChallenge?.exp || "",
//         title: selectedChallenge?.title || "",
//     });

//     useEffect(() => {
//         if (selectedChallenge?.categories && impacts.length > 0) {
//             // Cari nilai awal untuk dropdown berdasarkan nama kategori impact
//             const impact1 = impacts.find((impact) => impact.name === selectedChallenge.categories?.[0]?.impact_category?.name)?.id;
...
//                             <img src={selectedChallenge?.challenge_img ? selectedChallenge?.challenge_img : imageBg} className="object-cover rounded-2xl w-full h-full" alt="Preview" />
//                         </div>
//                     </div>
//                 </div>
...
//                     <select className="select w-full max-w-xs border border-[#E5E7EB]" id="category-label" value={selectedChallenge?.difficulty} name="difficulty" onChange={handleChange}>
...
//                         placeholder="Exp"
//                         onChange={handleChange}
//                         defaultValue={selectedChallenge?.exp}
//                     />
//                 </div>
...
//                         onChange={handleChange}
//                         defaultValue={selectedChallenge?.coin}
//                     />
//                 </div>
...
//                         onChange={handleChange}
//                         defaultValue={selectedChallenge?.duration_days}
//                     />
//                 </div>
...
const ModalEditChallenges = ({ selectedChallenge }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log(data);
        try {
            const response = await api.put(`/admin/challenges/${data.id}`, data);
