        ...
        <div className="bg-primary mt-20 w-[1152px] h-[327px]">
            ...
            <div className="bg-white h-fit w-[309px] rounded-xl p-12">
                ...
                <img
                    ...
                    alt="Profile Avatar"
                    className="w-[210px] h-[210px] rounded-full object-cover object-top"
                />
                <button
                    onClick={openModal}
                    className="absolute bottom-2 right-2 bg-primary text-white px-3 py-3 rounded-full text-sm hover:bg-gray-700"
                >
                    <Camera />
                </button>
                </div>
                <h1 className="mx-auto w-full text-center text-2xl font-semibold mt-5">
                {data.name || "Name not available"}
                </h1>
                <h1 className="mx-auto w-full text-center text-lg font-light">
