        ...
        <div>
            <div className="flex flex-row mx-auto w-full justify-center items-center gap-2">
                ...
                <div className="w-[520px] h-[470px] bg-white rounded-lg border border-gray-200">
                    ...
                    <h1 className="text-4xl font-bold mt-8 ml-8">Rp. {products.price}</h1>
                    ...
                    <div className="flex flex-row ml-8">
                        <button onClick={() => setAmount(amount - 1)} disabled={amount === 1} className="text-2xl font-bold py-1 px-4  border-primary border rounded-lg">-</button>
                        <h1 className="text-2xl font-bold py-1 px-4 ">{amount}</h1>
                        <button onClick={() => setAmount(amount + 1)} className="text-2xl font-bold py-1 px-4  border-primary border rounded-lg">+</button>
                        <h1 className="text-xl font-semibold py-1 px-4 ml-28">Subtotal Rp. {products.price * amount} </h1>
                    </div>
                    <div className="flex flex-col w-[456px] ml-8">
                        <button className="bg-primary text-white text-base font-bold py-3 text-center  mt-8 rounded-lg w-full">Beli sekarang</button>
                        <button className="border-primary border text-primary text-base font-bold py-3 text-center mt-3 rounded-lg">   
                            Tambah ke Keranjang
                        </button>
                    </div>
                </div>
