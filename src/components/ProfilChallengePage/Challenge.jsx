...
const Challenge = ({ challenges }) => {
    ...
    return (
        <div className="md:bg-primary md:mt-20 md:w-[1152px] md:h-[327px] mobileNormal:w-full mobileNormal:h-full relative">
            {challenges && <div className="flex md:flex-row mobileNormal:flex-col px-4 md:px-10 pt-40 gap-10">
            ...
            <div className="md:hidden bg-white h-[1000px] md:w-[624px] rounded-xl max-md:mb-[111px]">
                <div className="h-7">
                ...
                <div className="p-4">
                    <div className="border border-gray-300 h-[342px]  mx-auto mt-5 rounded-xl">
